...
class __TwigTemplate_737d6682ef4e93a6094b372a36c21c19bb4c25bd0dda22e0d026f3cdd5e3f688 extends Twig_Template
{
    ...
    ";
        ...
        if (($this->getAttribute(($context["row"] ?? $this->getContext($context, "row")), "getColumn", array(0 => ($context["column"] ?? $this->getContext($context, "column"))), "method") || ((($context["column"] ?? $this->getContext($context, "column")) == "label") && ($this->getAttribute(($context["row"] ?? $this->getContext($context, "row")), "getColumn", array(0 => ($context["column"] ?? $this->getContext($context, "column"))), "method") === "0")))) {
            if ((($context["column"] ?? $this->getContext($context, "column")) == "label")) {
                ...
                echo call_user_func_array($this->env->getFilter('number')->getCallable(), array($this->getAttribute(($context["row"] ?? $this->getContext($context, "row")), "getColumn", array(0 => ($context["column"] ?? $this->getContext($context, "column"))), "method"), 2, 0));
            }
        } else {
            // line 50
            echo "-";
...
{% endspaceless %}
", "@CoreHome/_dataTableCell.twig", "/var/www/html/analytics/plugins/CoreHome/templates/_dataTableCell.twig");
    }
}
