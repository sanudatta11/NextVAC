...
class __TwigTemplate_81a1e6f253697665d3907aeb0451ede3e01d7cb67e04a8a2a17a9cc530cefcc8 extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["id"] => $context["customVariable"]) {
                    ...
                    // line 9
                    echo "                - ";
                    echo $this->getAttribute($context["customVariable"], ($context["name"] ?? $this->getContext($context, "name")), array(), "array");
                    echo " ";
                    if ((twig_length_filter($this->env, $this->getAttribute($context["customVariable"], ($context["value"] ?? $this->getContext($context, "value")), array(), "array")) > 0)) {
                        echo " = ";
                        echo $this->getAttribute($context["customVariable"], ($context["value"] ?? $this->getContext($context, "value")), array(), "array");
                    }
                    // line 10
                    echo "
                ";
...
";
            ...
            if (twig_length_filter($this->env, trim(($context["customVariablesTooltip"] ?? $this->getContext($context, "customVariablesTooltip"))))) {
                // line 20
                echo "
";
                // line 21
                echo \Piwik\piwik_escape_filter($this->env, trim(($context["customVariablesTooltip"] ?? $this->getContext($context, "customVariablesTooltip"))), "html", null, true);
            }
            // line 22
        ...
        ";
            ...
            <span ";
                ...
                if (($this->getAttribute($context["action"], "type", array()) == "ecommerceOrder")) {
                    ...
                    echo ": ";
                    echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenue", array()), $this->getAttribute(($context["clientSideParameters"] ?? $this->getContext($context, "clientSideParameters")), "idSite", array())));
                    echo "
";
                    // line 45
                    if ( !twig_test_empty($this->getAttribute($context["action"], "revenueSubTotal", array()))) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenueSubTotal", array()), $this->getAttribute(($context["clientSideParameters"] ?? $this->getContext($context, "clientSideParameters")), "idSite", array())));
                    }
                    // line 46
                    echo "
";
                    ...
                    if ( !twig_test_empty($this->getAttribute($context["action"], "revenueTax", array()))) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenueTax", array()), $this->getAttribute(($context["clientSideParameters"] ?? $this->getContext($context, "clientSideParameters")), "idSite", array())));
                    }
                    // line 48
                    echo "
";
                    ...
                    if ( !twig_test_empty($this->getAttribute($context["action"], "revenueShipping", array()))) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenueShipping", array()), $this->getAttribute(($context["clientSideParameters"] ?? $this->getContext($context, "clientSideParameters")), "idSite", array())));
                    }
                    // line 50
                    echo "
";
                    ...
                    if ( !twig_test_empty($this->getAttribute($context["action"], "revenueDiscount", array()))) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["action"], "revenueDiscount", array()), $this->getAttribute(($context["clientSideParameters"] ?? $this->getContext($context, "clientSideParameters")), "idSite", array())));
                    }
                    $context["ecommerceOrderTooltip"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
                    // line 53
                    echo "                <abbr title=\"";
                    echo \Piwik\piwik_escape_filter($this->env, ($context["ecommerceOrderTooltip"] ?? $this->getContext($context, "ecommerceOrderTooltip")), "html", null, true);
                    echo "\">";
                    echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("General_ColumnRevenue")), "html", null, true);
                    echo ":
                ";
                ...
                if ( !twig_test_empty($this->getAttribute($context["action"], "itemDetails", array()))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                        ...
                        echo ": ";
                        echo call_user_func_array($this->env->getFilter('money')->getCallable(), array($this->getAttribute($context["product"], "price", array()), $this->getAttribute(($context["clientSideParameters"] ?? $this->getContext($context, "clientSideParameters")), "idSite", array())));
                        echo "
                            </li>
                        ";
                    }
...
($context["previousAction"] ?? null), "url", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["previousAction"] ?? null), "url", array()), false)) : (false)) == $this->getAttribute($context["action"], "url", array())))) {
                        // line 102
                        echo "                    ";
                        // line 103
                        echo "                ";
                        ...
                        // line 104
                        echo "                    ";
                        if ((((is_string($__internal_936a99fe228f55e0d1d629075189c23d4d71625bdc2b9dae53b1edbdb6ac532c = twig_lower_filter($this->env, trim($this->getAttribute($context["action"], "url", array())))) && is_string($__internal_de6ad4f882cbe273c34fd5d9b2e9e19f38ae89a79c288b39c91ab8a0c3a49b95 = "javascript:") && ('' === $__internal_de6ad4f882cbe273c34fd5d9b2e9e19f38ae89a79c288b39c91ab8a0c3a49b95 || 0 === strpos($__internal_936a99fe228f55e0d1d629075189c23d4d71625bdc2b9dae53b1edbdb6ac532c, $__internal_de6ad4f882cbe273c34fd5d9b2e9e19f38ae89a79c288b39c91ab8a0c3a49b95))) || (is_string($__internal_7519a2352fed96056f4fe02641578e8a30502997775ae8f11dcabfeccd3914ef = twig_lower_filter($this->env, trim($this->getAttribute(                        // line 105
$context["action"], "url", array())))) && is_string($__internal_446e747ea41e1038830338c278b1e662c202d3f91978a409b20b9e20469936ba = "vbscript:") && ('' === $__internal_446e747ea41e1038830338c278b1e662c202d3f91978a409b20b9e20469936ba || 0 === strpos($__internal_7519a2352fed96056f4fe02641578e8a30502997775ae8f11dcabfeccd3914ef, $__internal_446e747ea41e1038830338c278b1e662c202d3f91978a409b20b9e20469936ba)))) || (is_string($__internal_d2426ff5ab0527c2ddc1713dd2b04f9b7341090913b9a5e4b9a907689826f478 = twig_lower_filter($this->env, trim($this->getAttribute(                        // line 106
$context["action"], "url", array())))) && is_string($__internal_9a08efd1c7116ef5cbc78fa003262e6dc3805a8c568fd30af4fefefc41c14b6a = "data:") && ('' === $__internal_9a08efd1c7116ef5cbc78fa003262e6dc3805a8c568fd30af4fefefc41c14b6a || 0 === strpos($__internal_d2426ff5ab0527c2ddc1713dd2b04f9b7341090913b9a5e4b9a907689826f478, $__internal_9a08efd1c7116ef5cbc78fa003262e6dc3805a8c568fd30af4fefefc41c14b6a))))) {
                            // line 107
                            echo "                        ";
                            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($context["action"], "url", array()), "html", null, true);
                            echo "
                    ";
                       ...
                       ";
                            // line 110
                            if (( !array_key_exists("overrideLinkStyle", $context) || ($context["overrideLinkStyle"] ?? $this->getContext($context, "overrideLinkStyle")))) {
                                echo "style=\"text-decoration:underline;\"";
                            }
                            echo ">
                       ";
                            // line 111
                            echo \Piwik\piwik_escape_filter($this->env, twig_replace_filter($this->getAttribute($context["action"], "url", array()), array("http://" => "", "https://" => "")), "html", null, true);
                            echo "
                    </a>
                    ";
                        }
                ...
                <span>";
                    // line 118
                    echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute(($context["clientSideParameters"] ?? $this->getContext($context, "clientSideParameters")), "pageUrlNotDefined", array()), "html", null, true);
                    echo "</span>
                </p>
            ";
                }
...
{% endfor %}", "@Live/_actionsList.twig", "/var/www/html/analytics/plugins/Live/templates/_actionsList.twig");
    }
}
