...
class __TwigTemplate_ee211e1cdd01e3ce4eeb6ca51a278ee56da9efdb2a9c45d2da95e77eb826532b extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["visitor"]) {
            ...
            // line 6
            echo "    ";
            $context["breakBeforeVisitorRank"] = (((($context["visitHasEcommerceActivity"] ?? $this->getContext($context, "visitHasEcommerceActivity")) && $this->getAttribute($context["visitor"], "getColumn", array(0 => "visitorTypeIcon"), "method"))) ? (true) : (false));
            // line 7
            echo "    ";
            ob_start();
            // line 8
        ...
        <span class=\"visitorType\">
            ...
            if ($this->getAttribute($context["visitor"], "getColumn", array(0 => "visitConverted"), "method")) {
                ...
                echo "\" class='visitorRank visitorLogTooltip'
                      ";
                // line 54
                if (( !($context["displayVisitorsInOwnColumn"] ?? $this->getContext($context, "displayVisitorsInOwnColumn")) || ($context["breakBeforeVisitorRank"] ?? $this->getContext($context, "breakBeforeVisitorRank")))) {
    ...
    ";
        ...
        ";
            ...
            if (($this->getAttribute($context["visitor"], "getColumn", array(0 => "referrerType"), "method") == "search")) {
                ...
                // line 87
                $context["showKeyword"] = ( !twig_test_empty($this->getAttribute($context["visitor"], "getColumn", array(0 => "referrerKeyword"), "method")) && ($this->getAttribute($context["visitor"], "getColumn", array(0 => "referrerKeyword"), "method") != ($context["keywordNotDefined"] ?? $this->getContext($context, "keywordNotDefined"))));
                // line 88
...
GPS (lat/long): ";
            ...
            if ($this->getAttribute($context["visitor"], "getColumn", array(0 => "countryFlag"), "method")) {
                ...
                if ($this->getAttribute($context["visitor"], "getColumn", array(0 => "city"), "method")) {
                    echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array($this->getAttribute($context["visitor"], "getColumn", array(0 => "city"), "method")));
                }
                // line 165
                if ($this->getAttribute($context["visitor"], "getColumn", array(0 => "region"), "method")) {
                    ...
                    echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array($this->getAttribute($context["visitor"], "getColumn", array(0 => "region"), "method")));
                }
                // line 166
                echo "
                        <ul class=\"details\">
            ...
            if ($this->getAttribute($context["visitor"], "getColumn", array(0 => "customVariables"), "method")) {
                ...
                foreach ($context['_seq'] as $context["id"] => $context["customVariable"]) {
                    ...
                    echo ")\">
                            ";
                    // line 181
                    echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('truncate')->getCallable(), array($this->getAttribute($context["customVariable"], ($context["name"] ?? $this->getContext($context, "name")), array(), "array"), 30)), "html", null, true);
                    echo "
                        </acronym>
                    ";
                    // line 183
                    if ((twig_length_filter($this->env, $this->getAttribute($context["customVariable"], ($context["value"] ?? $this->getContext($context, "value")), array(), "array")) > 0)) {
                        echo ": ";
                        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('truncate')->getCallable(), array($this->getAttribute($context["customVariable"], ($context["value"] ?? $this->getContext($context, "value")), array(), "array"), 50)), "html", null, true);
                    }
                    // line 184
                    echo "                    ";
                }
            ...
            if ( !($context["displayVisitorsInOwnColumn"] ?? $this->getContext($context, "displayVisitorsInOwnColumn"))) {
                ...
                echo "                    <br/>
                    ";
                // line 188
                echo \Piwik\piwik_escape_filter($this->env, ($context["visitorColumnContent"] ?? $this->getContext($context, "visitorColumnContent")), "html", null, true);
                echo "
                ";
            }
            // line 190
            echo "                    ";
            echo \Piwik\piwik_escape_filter($this->env, ($context["referrerContent"] ?? $this->getContext($context, "referrerContent")), "html", null, true);
            echo "
            </div>
            ...
            echo "                </strong>
                ...
                <div class=\"visitor-log-page-list\">
                    <ol class='visitorLog'>
                        ";
            // line 214
            $this->loadTemplate("@Live/_actionsList.twig", "@Live/_dataTableViz_visitorLog.twig", 214)->display(array_merge($context, array("actionDetails" => $this->getAttribute($context["visitor"], "getColumn", array(0 => "actionDetails"), "method"))));
            // line 215
            echo "                    </ol>
                </div>
                ";
...
GPS (lat/long): {{ visitor.getColumn('latitude') }},{{ visitor.getColumn('longitude') }}{% endif %}\">
    ...
    {{ visitorRow }}
{% endfor %}
", "@Live/_dataTableViz_visitorLog.twig", "/var/www/html/analytics/plugins/Live/templates/_dataTableViz_visitorLog.twig");
    }
}
