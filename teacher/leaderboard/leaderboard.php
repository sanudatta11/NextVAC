...
if(isset($_GET['lcode']) && isset($_SESSION['secretkey']) && isset($_SESSION['designation']))
{
    ...
    //Adding Teacher Section Check

    //Checking that the code received is of the users section or not
    $section_check = $mysql_conn->prepare('SELECT * FROM nextvac.codingdb WHERE contestcode = :ccode AND secretkey = :seckey');
    $section_check->bindParam(':ccode',$key);
    $section_check->bindParam(':seckey',$_SESSION['secretkey']);
